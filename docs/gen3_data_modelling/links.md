...
- *Note: this page describes links as they appear in a `Gen3 Schema`. If you are generating your dictionary from an `input_yaml`, you declare links differently — see [Declaring links in the input_yaml](../gen3schemadev/input_yaml_links.md).*
